...
public class StartJetty {
    ...
    public static void main(String[] args) throws Exception {
         ...
         * SocketConnector(); // Set some timeout options to make debugging easier.
         ...
         * server.start(); while (System.in.available() == 0) { Thread.sleep(5000); }
         * server.stop(); server.join(); } catch (Exception e) { e.printStackTrace();
         * System.exit(100); }
         */
    }
}
